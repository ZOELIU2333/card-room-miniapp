...
- [Figma UI Prototype](https://www.figma.com/design/8dlFmCrIkB16GqoQepauHS)
...
Figma 当前交付以 `Prototype v2 - high fidelity` 页面为准：

- 首页、创建好友房、输入房号三屏都在 Figma 内
- 首页点击「创建好友房」直接进入创建页
- 首页点击「输入房号」直接进入输入页
- 不使用确认弹框
- 底部固定栏保留
- 后续 UI 和交互以 Figma 为交付源，不再以聊天图片为准
